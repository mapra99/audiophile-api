        ...
        Admin::V1::ProductContents::Creator.new(
          params: {
            ...
            content: "Reap the advantages of a flat diaphragm tweeter cone. This provides a fast response rate and \
                      ...
                      performance. It houses an encased MDF wooden enclosure which minimises acoustic resonance. Dual \
                      connectivity allows pairing through bluetooth or traditional optical and RCA input. Switch input \
                      sources and control volume at your finger tips with the included wireless remote. This versatile \
